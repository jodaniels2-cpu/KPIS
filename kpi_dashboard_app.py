...
st.set_page_config(page_title="Modality Lewisham — A‑Team KPI Dashboard (v9c2)", page_icon="🏥", layout="wide", initial_sidebar_state="expanded")
...
with st.sidebar:
    ...
    only_answered = st.checkbox("Only include answered/connected calls", value=True,
                                help="Untick to include all calls regardless of outcome")
...
is_callback = type_lower.str_contains = type_lower.str.contains("callback|call back|cb")
